...
%_______________________________________________________________________
% $Id: cat_defaults.m 1436 2019-03-06 16:46:15Z gaser $
...
cat.extopts.atlas       = { ... 
  fullfile(spm('dir'),'toolbox','cat12','templates_1.50mm','neuromorphometrics.nii')  1      {'csf','gm'}        1; ... % atlas based on 35 subjects
  fullfile(spm('dir'),'toolbox','cat12','templates_1.50mm','lpba40.nii')              1      {'gm'}              1; ... % atlas based on 40 subjects
  fullfile(spm('dir'),'toolbox','cat12','templates_1.50mm','cobra.nii')               1      {'gm','wm'}         1; ... % hippocampus-amygdala-cerebellum, 5 subjects, 0.6 mm voxel size 
  fullfile(spm('dir'),'toolbox','cat12','templates_1.50mm','hammers.nii')             1      {'csf','gm','wm'}   1; ... % atlas based on 20 subjects
  fullfile(spm('dir'),'toolbox','cat12','templates_1.50mm','ibsr.nii')                1      {'csf','gm'}        1; ... % less regions, 18 subjects, low T1 image quality
  fullfile(spm('dir'),'toolbox','cat12','templates_1.50mm','aal.nii')                 1      {'gm'}              1; ... % many regions, but only labeled on one subject 
