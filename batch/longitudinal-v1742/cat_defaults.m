...
cat.extopts.atlas       = { ... 
  fullfile(spm('dir'),'toolbox','cat12','templates_volumes','neuromorphometrics.nii')  1      {'csf','gm'}        1; ... % atlas based on 35 subjects
  fullfile(spm('dir'),'toolbox','cat12','templates_volumes','lpba40.nii')              1      {'gm'}              1; ... % atlas based on 40 subjects
  fullfile(spm('dir'),'toolbox','cat12','templates_volumes','cobra.nii')               1      {'gm','wm'}         1; ... % hippocampus-amygdala-cerebellum, 5 subjects, 0.6 mm voxel size 
  fullfile(spm('dir'),'toolbox','cat12','templates_volumes','hammers.nii')             1      {'csf','gm','wm'}   1; ... % atlas based on 20 subjects
  fullfile(spm('dir'),'toolbox','cat12','templates_volumes','ibsr.nii')                1      {'csf','gm'}        1; ... % less regions, 18 subjects, low T1 image quality
  ...
  fullfile(spm('dir'),'toolbox','cat12','templates_volumes','anatomy3.nii')            1      {'gm','wm'}         1; ... % 93 regions, 10 subjects
  ...
  fullfile(spm('dir'),'toolbox','cat12','templates_volumes','Schaefer2018_600Parcels_17Networks_order.nii') 1 {'gm'} 1; ... % atlas based on rsfMRI data from 1489 subjects
}; 
